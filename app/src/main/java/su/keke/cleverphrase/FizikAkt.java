...
public class FizikAkt extends AppCompatActivity {
    private TextView mTextViewtex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fizik_akt);
        mTextViewtex = (TextView)findViewById(R.id.tvfizika);
    ...
    public void bildGum (View view){
        ...
        String[]gum_list = getResources().getStringArray(R.array.fizika_list);
