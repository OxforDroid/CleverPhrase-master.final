...
public class PsixAkt extends AppCompatActivity {
    private TextView mTextViewtex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_psix_akt);
        mTextViewtex = (TextView)findViewById(R.id.tvpsix);
    ...
    public void bildGum (View view){
        ...
        String[]gum_list = getResources().getStringArray(R.array.psixlist);
