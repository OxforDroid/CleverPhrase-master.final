...
public class MatemAkt extends AppCompatActivity {
    private TextView mTextViewtex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_matem_akt);
        mTextViewtex = (TextView)findViewById(R.id.tvmatem);
    ...
    public void bildGum (View view){
        ...
        String[]gum_list = getResources().getStringArray(R.array.matemlist);
