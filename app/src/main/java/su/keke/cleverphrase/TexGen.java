...
public class TexGen extends AppCompatActivity {
    private TextView mTextViewtex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tex_gen);

        mTextViewtex = (TextView)findViewById(R.id.texgen);
...
//                        .setAction("Action", null).show();
    ...
    public void bildGum (View view){
        ...
        String[]gum_list = getResources().getStringArray(R.array.otvetlist);
