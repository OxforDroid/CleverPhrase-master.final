...
public class FilosofAkt extends AppCompatActivity {
    private TextView mTextViewtex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filosof_akt);
        mTextViewtex = (TextView)findViewById(R.id.tvfilosof);
    ...
    public void bildGum (View view){
        ...
        String[]gum_list = getResources().getStringArray(R.array.filoslist);
